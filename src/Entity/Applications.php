 ...
 * Applications
 *
 * @ORM\Table(name="applications", indexes={@ORM\Index(name="id_label", columns={"id_label"})})
 * @ORM\Entity
 */
class Applications
{
     ...
     *
     * @ORM\ManyToMany(targetEntity="Portfolios", mappedBy="idApp")
     */
    private $idPortfolio;
