(function($) {
  ...
  $.fn.tweet = function(o){
    var s = {
      username: ["NoStarSunshine1"],              // [string]   required, unless you want to display our tweets. :) it can be an array, just do ["username1","username2","etc"]
      ...
      $(widget).bind("load", function(){
        ...
        $.getJSON(build_url(), function(data){
          ...
          $.each(tweets, function(i,item){
            ...
            // list.append('<div> ' + /*avatar + date* +*/ join + text + '</div>');
			$('<div> ' + /*avatar + date* +*/ join + text + '</div>').appendTo(widget);
			
            list.children('div:first').addClass('tweet_first');
            list.children('div:odd').addClass('tweet_even');
            list.children('div:even').addClass('tweet_odd');
          });
